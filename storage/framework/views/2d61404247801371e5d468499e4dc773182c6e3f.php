...
<!-- Top Bar -->
<nav class="navbar">
   <?php echo $__env->make('layouts.users.topbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</nav>
<!-- #Top Bar -->
<section>
   <?php echo $__env->make('layouts.users.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<section class="content">
    ...
    <?php echo $__env->yieldContent('content'); ?>
            ...
            <?php echo $__env->make('layouts.users.right', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
    </div>
</section>
